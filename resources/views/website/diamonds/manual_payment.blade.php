            ...
            <div class="mt-5">
                ...
                <div class="mt-3 grid grid-cols-1 gap-3">
                    @foreach($methodKeys as $key)
                        ...
                        <div class="payment-card payment-card-{{ $key }} rounded-2xl border border-gray-200 bg-white shadow-sm p-4"
                             data-method-key="{{ $key }}">
                            <div class="flex items-center justify-between gap-3">
                                <div class="text-sm font-extrabold text-gray-900">{{ $m['title'] ?? $key }}</div>
                                <span class="payment-badge hidden text-[11px] font-extrabold text-blue-700 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded-full">
                                    محدد
                                </span>
                            </div>
                                    ...
                                    @if(!empty($m['bank_name']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['bank_name'] }}" aria-label="Copy">
                                    ...
                                    @if(!empty($m['account_name']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['account_name'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                                    ...
                                    @if(!empty($m['account_number']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['account_number'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                                    ...
                                    @if(!empty($m['iban']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['iban'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                                    ...
                                    @if(!empty($m['click_id']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['click_id'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                                ...
                                @elseif($key === 'binance_trc20')
                                    <div class="py-2 flex items-center justify-between gap-3">
                                        ...
                                        <span class="flex items-center gap-2">
                                            ...
                                            <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                    data-copy-text="{{ $m['network'] ?? 'TRC20' }}" aria-label="Copy">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                    <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                </svg>
                                            </button>
                                    ...
                                    @if(!empty($m['address']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['address'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                                    ...
                                    @if(!empty($m['link']))
                                        <div class="py-2 flex items-center justify-between gap-3">
                                            ...
                                            <span class="flex items-center gap-2">
                                                ...
                                                <button type="button" class="copy-trigger text-blue-600 hover:text-blue-800"
                                                        data-copy-text="{{ $m['link'] }}" aria-label="Copy">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M16 1H4C2.9 1 2 1.9 2 3v14h2V3h12V1zm3 4H8C6.9 5 6 5.9 6 7v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>
                                                    </svg>
                                                </button>
                            ...
                            @if(!empty($m['note']))
                                <div class="mt-3 text-xs text-gray-500">{{ $m['note'] }}</div>
                            @endif
                        </div>
                    @endforeach
                </div>
...
<script>
  (function () {
    ...
    const toggle = (key) => {
      ...
      const target = document.querySelector('.payment-card-' + key);
      if (target) {
