  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12 flex flex-row flex-wrap justify-center sm:justify-between items-start gap-10 text-center sm:text-right">
    ...
    <div class="flex flex-col items-center sm:items-start">
      ...
      <ul class="space-y-2 text-sm text-gray-300">
        ...
        @if($whatsappHref)
          <li>
            <a href="{{ $whatsappHref }}" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center sm:justify-start gap-2 hover:text-green-400 transition">
        ...
        @endif
        <li>
          <a href="{{ config('contact.instagram_url') }}" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center sm:justify-start gap-2 hover:text-pink-400 transition">
